...
import api.medical_examination as medical_examination_api
...
def test_medical_examination_create_requires_authentication():
    client = TestClient(app)

    response = client.post(
        f"/api/medical-examinations?organization_id={ORGANIZATION_ID}",
        json={
...
def test_medical_examination_create_rejects_missing_application_for_organization(
    monkeypatch,
):
    monkeypatch.setattr(
...
def test_medical_examination_get_by_application_requires_organization_owned_application(
    monkeypatch,
):
    ...
    response = client.get(
        "/api/medical-examinations/application/"
...
def test_medical_examination_get_by_id_rejects_medical_examination_from_other_organization(
    monkeypatch,
):
